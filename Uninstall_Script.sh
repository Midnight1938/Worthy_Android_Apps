...
#! and still have a bunch of Facebook services?

adb shell pm uninstall -k --user 0 com.facebook.katana 	# Facebook mobile app
...
sg.bigo.live 	                                                # Some sexist 'horny men give me money' app
ru.auto.ara 	                                                # auto.ru app
#! Some Russian mobile operators use SIM card 
#! built-in application to promote paid services.
